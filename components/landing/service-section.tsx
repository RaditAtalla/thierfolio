...
export default function ServiceSection() {
  return (
    <section className="relative pt-[79px] pb-[129px] before:pointer-events-none before:absolute before:inset-0 before:border before:border-[#EBE5E5] before:border-t-0 before:z-10">
      <h2 className="text-[31px] md:text-[49px] text-center relative mb-[53px] md:mb-[79px]">
      ...
      <div className="flex flex-col items-center gap-[37px] md:gap-[74px] px-[17px] lg:px-[70px] xl:px-[142px]">
